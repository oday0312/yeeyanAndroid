package com.devspark.sidenavigation.yeeyanAndroid.LoadMoreListView;
...
import com.devspark.sidenavigation.yeeyanAndroid.R;
...
public class PullAndLoadListView extends PullToRefreshListView {
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		if (mOnLoadMoreListener != null) {
			...
			if (!mIsLoadingMore && loadMore && mRefreshState != PullToRefreshListView.REFRESHING
					&& mCurrentScrollState != AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
